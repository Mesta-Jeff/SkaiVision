                ...
                <div class="row align-items-center">
                    <div class="col-md-8">
                        <div class="page-header-title">
                            ...
                            <p class="m-b-0">Welcome to {{ env('APP_ALLIASE') }}</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <ul class="breadcrumb">
                                        ...
                                        <div class="card text-center order-visitor-card">
                                            <div class="card-block">
                                                ...
                                                <h4 class="m-t-15 m-b-15"><i
                                                        class="fa fa-arrow-down m-r-15 text-c-red"></i>7652</h4>
                                    ...
                                    <div class="col-md-6">
                                        <div class="card text-center order-visitor-card">
                                            <div class="card-block">
                                                ...
                                                <h4 class="m-t-15 m-b-15"><i
                                                        class="fa fa-arrow-up m-r-15 text-c-green"></i>6325</h4>
                                    ...
                                    <div class="col-md-6">
                                        <div class="card text-center order-visitor-card">
                                            <div class="card-block">
                                                ...
                                                <h4 class="m-t-15 m-b-15"><i
                                                        class="fa fa-arrow-down m-r-15 text-c-red"></i>652</h4>
                                                <p class="m-b-0">36% From Last 6 Months</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="card text-center order-visitor-card">
                                            <div class="card-block">
                                                ...
                                                <h4 class="m-t-15 m-b-15"><i
                                                        class="fa fa-arrow-up m-r-15 text-c-green"></i>5963</h4>
                                                <p class="m-b-0">36% From Last 6 Months</p>
                                            </div>
                                        </div>
                                    </div>
