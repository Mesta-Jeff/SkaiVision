...
$("body").append('<div class="fixed-button active"><a href="#" class="btn btn-md btn-primary"><i class="fa fa-send" aria-hidden="true"></i> Chat Us</a> </div>');var $window=$(window),nav=$(".fixed-button");
